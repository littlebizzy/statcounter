...
final class STCNTR_Admin_Notices {
	...
	private $suggestions = array(
		...
		'fb-pixel-littlebizzy' => array(
			'name' => 'Facebook Pixel',
			'desc' => 'Inserts the Facebook Pixel site-wide just above the closing body tag to ensure fastest performance and to avoid conflicting with any other scripts.',
			'filename' => 'facebook-pixel.php',
		),
