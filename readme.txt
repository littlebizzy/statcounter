...
It loads faster and performs better than the official StatCounter plugin and is updated regularly, meaning its more reliable than also pasting your tracking code directly into a theme template file or injecting it using a footer code plugin.
...
* Database Queries: Backend + Frontend (Options API)
